...
namespace WebApplication1.Controllers
{
	...
	public class ClientController : ControllerBase
	{
		...
		public async Task<IActionResult> RegisterUser([FromForm] DTOClient userDto)
		{
			...
			try
			{
				Client user = await this._clientService.CreateClientAsync(userDto); // Вызов нового метода
        ...
        [HttpGet("current")]
        [ProducesResponseType(typeof(Client), 200)]  // Для Swagger: успешный ответ с типом Client
